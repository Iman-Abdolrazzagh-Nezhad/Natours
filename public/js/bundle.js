      ...
      while (1) switch (_context.p = _context.n) {
        ...
        case 1:
          ...
          if (res.data.status === 'success') {
            (0, _alerts.showAlert)('success', 'You are loged in successfuly.');
    ...
    return _regenerator().w(function (_context2) {
      while (1) switch (_context2.p = _context2.n) {
        ...
        case 2:
          _context2.p = 2;
          _t2 = _context2.v;
          (0, _alerts.showAlert)('error', 'Error while trying to logout! Please Try again.');
        case 3:
    ...
    return _regenerator().w(function (_context) {
      while (1) switch (_context.p = _context.n) {
        ...
        case 1:
          res = _context.v;
          if (res.data.status === 'success') {
            (0, _alerts.showAlert)('success', "".concat(type.toUpperCase(), " changed successfuly!"));
            window.setTimeout(function () {
              location.assign('/me');
            }, 1500);
          }
...
var newUserData = document.querySelector('.form-user-data');
var newUserPassword = document.querySelector('.form-user-password');
if (newUserPassword) {
  newUserPassword.addEventListener('submit', /*#__PURE__*/function () {
